...
from dataset_generation.utils import cameras
from dataset_generation.tasks import primitives
from dataset_generation.tasks.grippers import Suction
...
class Task:
    ...
    def reward(
        ...
        if fail:
            ...
            success_rate_per_lang = step_reward / max_reward
            return success_rate_per_lang
